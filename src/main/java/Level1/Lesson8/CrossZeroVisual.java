...
public class CrossZeroVisual {
    ...
    private static File clipFile = new File("src/main/java/Level1/Lesson8/music/clip.wav");
    private static File failFile = new File("src/main/java/Level1/Lesson8/music/fail.wav");
    private static File winFile = new File("src/main/java/Level1/Lesson8/music/win.wav");
